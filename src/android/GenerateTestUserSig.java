...
public class GenerateTestUserSig {
     ...
     * 它是腾讯云用于区分客户的唯一标识。
     */
    public static final int SDKAPPID = 1400447762;
     ...
     */
    public static final String SECRETKEY = "3d860dc15ef9461f31c580b1b814f96003ff90a2b8555e08e148228b189978e9";
    private static final byte plussym = "+".getBytes()[0];
    private static final byte strisym = "/".getBytes()[0];
    private static final byte undersym = "=".getBytes()[0];
    /**
     * 计算 UserSig 签名
     *
    ...
    private static byte[] base64EncodeUrl(byte[] input) {
        String base64string = new String(Base64.encode(input, Base64.NO_WRAP));
        String[] tmpchar = new String[]{base64string};
        ...
        for (int i = 0; i < tmpchar.length; ++i)
            switch (tmpchar[i]) {
                ...
                case "=":
                    tmpchar[i] = "_";
                    //base64 = tmpchar.getBytes()[0];
                    break;
                default:
                    break;
            }
        String str = TextUtils.join("", tmpchar);
